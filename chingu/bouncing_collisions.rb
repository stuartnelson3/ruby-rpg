...
class Game < Chingu::Window
  ...
  def initialize
    ...
    @ball2.diameter = 3 # cm
    @ball2.density = 5 # g/cm^3; equivalent to 2 g/cm^3
    # @ball.x, @ball.y = width / 2, height / 2 # center of screen
  ...
  def update
    ...
    @ball.each_bounding_circle_collision(@ball2) do |b1, b2|
      # b1.momentum, b2.momentum = b2.momentum, b1.momentum
...
class MomentumTransfer
  class << self
    def calculate(obj1, obj2)
      # complete transfer
      if obj1.momentum.abs > obj2.momentum
        # obj2.momentum = obj1.momentum
        obj2.dx = obj1.momentum / obj2.mass
        obj1.dx = 0
        obj2.calc_momentum
        # obj2.momentum = obj1.momentum
        # obj1.momentum = 0
        # obj2.recalc_dx
        # obj1.recalc_dx
      elsif obj2.momentum.abs > obj1.momentum
        obj1.dx = obj2.momentum / obj1.mass
        obj2.dx = 0
        obj1.calc_momentum
      end
    end
